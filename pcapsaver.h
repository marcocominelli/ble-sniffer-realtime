...
/* Copyright 2018 Marco Cominelli
   Copyright 2018 Francesco Gringoli

   This file is part of Foobar, a Bluetooth analyzer.
...
#ifndef _PCAP_SAVER_H_
#define _PCAP_SAVER_H_
...
public:
	...
	int addpacket(struct timeval *ts, int channel,
